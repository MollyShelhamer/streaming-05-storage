...
# Additional CSV field added by this consumer example
PROCESSED_TIMESTAMP_FIELD: Final[str] = "processed_timestamp"
...
def consume_messages(
    ...
    while consumed_count + skipped_count < MAX_MESSAGES:
        ...
        LOG.debug("Consumed message: %s", json.dumps(row, default=str))
